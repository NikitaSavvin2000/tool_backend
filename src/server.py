...
from src.xgboost_selection_of_parameters.cols_selection import user_predict_XGBoost
...
@app.post("/backend/v1/new_user_forecast")
async def func_user_forecast(body: Annotated[
    PredictRequest, Body(
        example={
            "df": example_df_json_long,
    ...
    try:
        ...
        response = user_predict_XGBoost(df, time_column, col_target, forecast_horizon_time)
        return response
