...
api_router.include_router(lstm_router, prefix="/lstm", tags=["LSTM"])
api_router.include_router(xgboost_router, prefix="/xgboost", tags=["XGBoost"])
...
api_router.include_router(analytics_router, prefix="/analyticsdfs", tags=["Analytics"])
api_router.include_router(all_metrics_router, prefix="/all-metrics", tags=["Metrics"])