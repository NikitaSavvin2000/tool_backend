...
def get_mock_benchmark_data() -> BenchmarkStaticResponse:
    """
    Формирует моковые данные для бенчмарков.
    
    :return: Схема BenchmarkStaticResponse с данными бенчмарков.
    """
    return BenchmarkStaticResponse( 
        datasets=[
            BenchmarkDataset(
                ...
                models=[
                    ...
                    BenchmarkModelMetric(
                        name="ARIMA",
                        metrics={"MAE": 9.0, "RMSE": 9.8, "MAPE": 0.0}, 
                        relative_to_horizon={"MAE": -35.1, "RMSE": -37.1, "MAPE": 0.0} 
                    ),
                    BenchmarkModelMetric(
                        name="SARIMA",
                        metrics={"MAE": 10.2, "RMSE": 10.8, "MAPE": 0.0}, 
                        relative_to_horizon={"MAE": -43.5, "RMSE": -44.3, "MAPE": 0.0} 
                    )
                ],
            )
        ],
